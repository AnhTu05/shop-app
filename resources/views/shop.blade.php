...
<main class="pt-90">
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Page Size"
              name="total-number" id="pagesize" style="margin-right: 20px">
            ...
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Sort Items"
              ...
              <option value="1" {{ $order == 2 ?  'selected' : ''}}>Date, New to Old</option>
              <option value="2" {{ $order == 3 ?  'selected' : ''}}>Date, Old to New</option>
              <option value="3" {{ $order == 4 ?  'selected' : ''}}>Price, Low to High</option>
              <option value="4" {{ $order == 5 ?  'selected' : ''}}>Price, High to Low</option>
            </select>
  ...
  <form action="" id="frmfilter" method="GET" action="{{ route('shop.index') }}">
