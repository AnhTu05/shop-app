...
Route::put('/cart/increase/{rowId}', [CartController::class, 'increse_cart_quantity'])->name('cart.qty.increase');
Route::put('/cart/decrease/{rowId}', [CartController::class, 'decrese_cart_quantity'])->name('cart.qty.decrease');
